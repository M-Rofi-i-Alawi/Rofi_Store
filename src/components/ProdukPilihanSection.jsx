    ...
    <section id="produk-pilihan" style={{ padding: '5rem 0' }}>
      <div className="app-container">
        ...
        <div style={{ maxWidth: '580px', margin: '0 auto' }}>
          {menuItems.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '3rem 1.5rem', backgroundColor: 'var(--card-bg)', borderRadius: '24px', border: '1px dashed var(--border-color)' }}>
              <i className="fas fa-cookie-bite" style={{ fontSize: '2.8rem', color: 'var(--dr-primary)', marginBottom: '1rem' }}></i>
              <h4 style={{ fontSize: '1.25rem', fontWeight: '800', color: 'var(--dark)', marginBottom: '0.5rem' }}>Menu Dapur Rofi Belum Tersedia</h4>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
                Semua produk saat ini telah dikosongkan. Nantikan pembaruan varian baru dari Dapur Rofi!
              </p>
            </div>
          ) : (
